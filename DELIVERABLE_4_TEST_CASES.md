...
3. [Authentication Module Tests](#authentication-module-tests)
4. [User Management Module Tests](#user-management-module-tests)
5. [Inventory Management Module Tests](#inventory-management-module-tests)
6. [Stock Management Module Tests](#stock-management-module-tests)
7. [Pick Operations Module Tests](#pick-operations-module-tests)
8. [Shipment Management Module Tests](#shipment-management-module-tests)
9. [Dashboard Module Tests](#dashboard-module-tests)
10. [Order Management Module Tests](#order-management-module-tests)
11. [API Integration Tests](#api-integration-tests)
...
The Flowventory system implements a hierarchical role-based access control (RBAC) model with three primary user roles. Each role has specific permissions and capabilities designed to support their workflow needs.

### Role Hierarchy

**Access Levels (from highest to lowest):**
1. **Admin** - Full system access
2. **Manager** - Elevated access for inventory and shipment management
3. **Engineer** - Standard operational access

---

### 1. Admin

**Access Level:** Full system access (all features)

**Primary Responsibilities:**
- Manage users, roles, and system configuration
- Access all system features including audit logs and security settings
- Oversee system integrity and operational continuity
- Configure application settings and permissions

**Key Features:**
- User management (create, edit, delete users)
- Role assignment and permission management
- Access to admin panel and configuration settings
- View audit logs and system analytics
- Full access to all modules: Dashboard, Stock, Pick, Shipments, Inventory, Orders
- Troubleshooting and system maintenance capabilities

**Use Cases:**
- Create and manage user accounts for the organization
- Configure system-wide settings and security policies
- Monitor system usage and performance
- Grant or revoke access to features for other users
- Maintain data integrity and compliance

**Priority:** System integrity and operational continuity
...
**Access Level:** Elevated access (Admin + Manager + Engineer features)

**Primary Responsibilities:**
- Create packing slips by filling out shipment forms
- Manage inventory and shipment operations
- Filter and tag shipments by urgency, vendor, or project
- View and manage shipments in the shipments table

**Key Features:**
- Fill out packing slip forms for incoming/outgoing shipments
- View all shipments in the shipments table
- Manage inventory items (add, edit, delete)
- Create and manage shipment records
- Filter and tag shipments by urgency, vendor, or project
- Access to: Dashboard, Stock, Pick, Shipments, Inventory, Orders
- Track shipment status and delivery schedules

**Use Cases:**
- Fill out packing slip forms for new shipments
- Create shipment records for outgoing deliveries
- View shipments table to track all active shipments
- Filter shipments by urgency, vendor, or project tags
- Coordinate with engineers on deployment schedules
- Manage inventory levels and reorder points

**Technical Proficiency:** Comfortable with technical workflows and documentation standards

**Priority:** Accuracy and efficiency in preparing deployments
...
**Access Level:** Standard operational access (Engineer features only)

**Primary Responsibilities:**
- Create packing slips by filling out shipment forms to track who is delivering items and where
- Perform pick operations from inventory
- View shipments in the shipments table
- Execute day-to-day inventory operations

**Key Features:**
- Fill out packing slip forms for outbound shipments
- View shipments table to see all shipment records
- Search and pick items from warehouse inventory
- View warehouse location details (zone, aisle, rack, shelf, bin)
- Update inventory quantities during pick operations
- Track delivery assignments and responsibilities
- Access to: Dashboard, Stock, Pick, Shipments, Inventory
...
**Use Cases:**
- Fill out packing slip forms for items being shipped
- Document who is responsible for each delivery in the shipment form
- View shipments table to track deliveries
- Receive pick orders and locate items in warehouse
- Update inventory quantities after picking
- Record warehouse locations during stocking operations

**Technical Proficiency:** Comfortable with technical workflows and documentation standards

**Priority:** Accuracy and efficiency in warehouse operations
...
| Feature / Module | Admin | Manager | Engineer |
|-----------------|-------|---------|----------|
| Dashboard | ✅ Full | ✅ Full | ✅ View |
| User Management (Admin Panel) | ✅ Full | ❌ No Access | ❌ No Access |
| Inventory Management | ✅ Full | ✅ Full | ✅ View/Update |
| Stock Management | ✅ Full | ✅ Full | ✅ Full |
| Pick Operations | ✅ Full | ✅ Full | ✅ Full |
| Shipment Management | ✅ Full | ✅ Full | ✅ View/Create |
| Create Packing Slips (Fill Form) | ✅ Full | ✅ Full | ✅ Create |
| View Shipments Table | ✅ Full | ✅ Full | ✅ View |
| Order Management | ✅ Full | ✅ Full | ✅ View |
| Audit Logs | ✅ Full | ❌ No Access | ❌ No Access |
| System Configuration | ✅ Full | ❌ No Access | ❌ No Access |
| Filter/Tag Shipments | ✅ Full | ✅ Full | ✅ View |

---

### Test Users

The following test users are configured in the system for testing purposes:
...
[
  ...
  {"username": "Carlotta", "password": "C@rl456@", "role": "manager"},
